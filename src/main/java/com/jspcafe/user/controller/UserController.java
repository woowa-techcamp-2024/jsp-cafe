...
public class UserController extends HttpServlet {
  ...
  private void updateProfileForm(HttpServletRequest req, HttpServletResponse resp)
      throws ServletException, IOException {
  ...
  private void updateProfileFormFailed(HttpServletRequest req, HttpServletResponse resp)
      throws ServletException, IOException {
