...
public record Reply(String id, String articleId, String userId, String nickname, String content, LocalDateTime createAt, LocalDateTime updateAt) {
    public static Reply create(String articleId, String userId, String nickname, String content) {
        return new Reply(UUID.randomUUID().toString(), articleId, userId, nickname, content, LocalDateTime.now(), LocalDateTime.now());
    }
