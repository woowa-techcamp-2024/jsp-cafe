...
public record Article(String id, String userId, String title, String nickname, String content, LocalDateTime createAt, LocalDateTime updateAt) {
    public static Article create(String userId, String title, String nickname, String content) {
        return new Article(UUID.randomUUID().toString(), userId, title, nickname, content, LocalDateTime.now(), LocalDateTime.now());
    }
