...
public class ArticleService {
    ...
    public ArticleCommonResponse createArticle(Map<String, String[]> parameterMap) {
        ...
        Article article = new Article(title, writer, contents);
    ...
    public List<ArticleCommonResponse> findAllArticle() {
        return articleRepository.findAll().stream().map(ArticleCommonResponse::from).toList();
    }
}
