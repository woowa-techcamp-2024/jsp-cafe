        ...
        <div class="bg-white shadow-2xl rounded-lg overflow-hidden">
            <div class="p-8">
                ...
                <div class="flex justify-center">
                    <a href="<c:url value='/'/>" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        홈으로 돌아가기
                    </a>
                </div>
            </div>
