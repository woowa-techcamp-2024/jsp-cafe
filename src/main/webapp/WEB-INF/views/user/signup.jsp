  ...
  <div class="w-full max-w-md">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nickname" type="text" placeholder="닉네임을 입력해주세요">
      </div>
      <div class="mb-6">
      ...
      <div class="flex items-center justify-between mb-6">
        <button class="bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" type="submit">
          회원가입
        </button>
      </div>
      <div class="text-center">
        <span class="text-gray-600">이미 회원이신가요? </span>
        <a href="login.html" class="text-teal-500 hover:text-teal-600">로그인하기</a>
      </div>
    </form>
  </div>
</main>
