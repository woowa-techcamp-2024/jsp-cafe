    ...
    <div class="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button id="deleteButton"
                    class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">삭제
            </button>
            <a href="/"
               class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">목록</a>
        </div>
    </div>
