    ...
    <div class="col-md-12">
        <div class="navbar-header">
            ...
            <ul class="nav dropdown-menu">
                <li><a href="/users/${sessionScope.userId}"><i class="glyphicon glyphicon-user" style="color:#1111dd;"></i> Profile</a>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <li><a href="/users/${sessionScope.userId}/edit" role="button">개인정보수정</a></li>
                    </c:otherwise>
                </c:choose>
            </ul>
        </div>
