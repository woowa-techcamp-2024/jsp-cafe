...
<div id="loginModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form.jsp.jsp class="form.jsp.jsp col-md-12 center-block">
              <div class="form.jsp.jsp-group">
                  <label for="userId">사용자 아이디</label>
                  <input class="form.jsp.jsp-control" name="userId" placeholder="User ID">
              </div>
              <div class="form.jsp.jsp-group">
                  <label for="password">비밀번호</label>
                  <input type="password" class="form.jsp.jsp-control" name="password" placeholder="Password">
              </div>
              <div class="form.jsp.jsp-group">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form.jsp.jsp class="form.jsp.jsp col-md-12 center-block">
              <div class="form.jsp.jsp-group">
                  <label for="userId">사용자 아이디</label>
                  <input class="form.jsp.jsp-control" id="userId" name="userId" placeholder="User ID">
              </div>
              <div class="form.jsp.jsp-group">
                  <label for="password">비밀번호</label>
                  <input type="password" class="form.jsp.jsp-control" id="password" name="password" placeholder="Password">
              </div>
              <div class="form.jsp.jsp-group">
                  <label for="name">이름</label>
                  <input class="form.jsp.jsp-control" id="name" name="name" placeholder="Name">
              </div>
              <div class="form.jsp.jsp-group">
                  <label for="email">이메일</label>
                  <input type="email" class="form.jsp.jsp-control" id="email" name="email" placeholder="Email">
              </div>
            <div class="form.jsp.jsp-group">
